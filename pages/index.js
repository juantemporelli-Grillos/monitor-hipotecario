...
export default function Monitor() {
  ...
  const sortedBanks = [...banks].sort((a, b) => {
    ...
    if (sortBy === "cuota_ingreso") {
      // Ingreso mínimo para pedir $10M = cuota x 100 / 0.25
      // Menor ingreso requerido = más accesible → va primero
      const ingresoA = cuotaX100k(a.tna, a.plazo) * 100 / 0.25;
      const ingresoB = cuotaX100k(b.tna, b.plazo) * 100 / 0.25;
